...
st.title("⚖️ GFR Legal Assistant (Qwen 2.5 7B - 4bit)")
st.markdown("Ask financial and legal questions about the General Financial Rules (GFR) 2025.")

# --------------------------------------------------------------------------------
# Model & DB Loading
# Using Qwen2.5-7B-Instruct — smaller model (4GB VRAM), faster inference (~30s)
# Good for comparison with 14B model in thesis
# --------------------------------------------------------------------------------
...
def load_rag_pipeline():
    ...
    # 4-bit quantization: ~4GB VRAM only
...
# --------------------------------------------------------------------------------
# Query Classifier — Only greeting/meta intercepted, everything else → RAG
# --------------------------------------------------------------------------------
import re as _re
...
META_RESPONSE = ("I'm the **GFR Legal Assistant**, powered by **Qwen 2.5 7B** running locally. "
